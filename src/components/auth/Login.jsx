...
export const Login = () => {
  ...
  <div className="min-h-screen flex flex-col justify-center">
    <div className=" flex flex-col p-10 w-1/3 mx-auto md:w-full md:max-w-md">
      <h1 className="font-bold text-center text-2xl mb-5 text-white">GlobeTrek</h1>  
      <form className="bg-white shadow w-full rounded-lg" onSubmit={handleLogin}>
        <fieldset className="flex px-5 py-7">
          ...
          justify-center py-2.5 rounded-lg text-sm font-semibold text-center">Login</button>
            </div>
        </form>
      <div className="py-5">
